...
const TABLE_HEAD = [
    { id: "objectivo", label: "Objectivo", alignRight: false },
    { id: "total", label: "Total", alignRight: false },
    { id: "target", label: "Target", alignRight: false },
    { id: "progress", label: "Progress", alignRight: false },
    { id: "% de Realização", label: "% de Realização", alignRight: false },
    { id: "obs", label: "Obs", alignRight: false },
    ...
    <Page title="Parceiro Publicidade">
      <Container>
        ...
        <Card>
          <Container>
            <ContentStyle>
              <Page title="Resultado de Vendas">
                <Container>
              ...
              <DialogContent dividers>
                ...
                >
                  <FormControl fullWidth>
                    <InputLabel id="objective">Objectivo</InputLabel>
                    <Select
                      labelId="objective"
                      name="objective"
                      label="Objectivo"
                      ...
                      error={Boolean(props.touched.objective && props.errors.objective)}
                      helperText={props.touched.objective && props.errors.objective}
                    >
                ...
                >
                  <TextField
                        ...
                        onChange={props.handleChange}
                        onBlur={props.handleBlur}
                        value={props.values.objectiveValue}
                        error={Boolean(props.touched.objectiveValue && props.errors.objectiveValue)}
                        helperText={props.touched.objectiveValue && props.errors.objectiveValue}
                    />
                </Stack>
              </DialogContent>
              <DialogActions>
